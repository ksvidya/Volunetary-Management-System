...
function checkform ( form )
{
  ...
  // ** START **
  if (form.vname.value == ""||form.cid.value == ""||form.vcid.value==""||form.vemail.value==""||form.vcontact.value=="") {
...
<tr><td>
<font color="black" style="font-family:carlito;font-size:160%;font-weight:bold; font-style:italic;">Email:</td><td><input type="text" name="vemail" id="vemail">
</td></tr>
<tr><td>
...
<input type="submit" style="font-family: 'carlito';font-size:medium;color: white; background-color: blue; margin-right:-40%;height:30px;width:75px;border-radius:10px;" value="Register">
